...
\projectinfo{
  ...
  Zameral som sa teda na preštudovanie dostupných zdrojov dát pre takýto prieskum a na spôsoby jeho vypracovania. 
  ...
  Monitored web servers are those that contain \mbox{a HTTP} header \code{NEL} in the HTTP responses they send out to their clients.
  ...
  In addition to the input data obtained like this, I also collected more data containing HTTP traffic recorded in the present from a set of relevant domains selected from HTTP Archive's data.
  This additional data was obtained by using my own implementation of a tool for automated web browsing, that was created as a part of this thesis' work.
  ...
  Ďalšia pomoc bola poskytnutá jeho kolegom, Ing. Kamilom Jeřábkom, ktorý mi pomohol s používaním ním vytvoreného programu, ktorý je využitý \mbox{v tejto} práci. 
  Uviedol som všetky literárne pramene, publikácie a ďalšie zdroje, s ktorých som čerpal.},
