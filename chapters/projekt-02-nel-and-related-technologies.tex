...
% \todo{Chromium based browsers ONLY support NEL}
% TODO use more from NEL-Client-side-Measurement-of-E2E-WS-Reliability
% TODO discover what terms i did NOT name
% TODO mark text that requires citations
% TODO cite everything 
% \todo{cite the images} - learn how to cite the images
...
že smerovanie dokumentov vo webovom prostredí funguje na základe smerovania správ pomocou IP adries. % TODO cite
Ďalej sa využíva protokol TCP, ktorého úlohou je nadviazať spojenie s počítačom označeným adresou IP.
Využitie týchto dvoch protokolov v spojení sa označuje za TCP/IP sieťovú komunikáciu. % TODO cite
...
\begin{itemize}
    ...
    Pri registráciach TLD je bežne vykonávateľom samotnej registrácie registrar. % ? (ale asi celkovo vymazat.. netreba mi to tu)
\end{itemize}
% TODO cite
% rfc8499 pages 2,15,
...
% TODO fact check + weird wording check
...
% \\
V oblasti sietí termín protokol predstavuje štandardizovanú množinu pravidiel pre vzájomnú komunikáciu medzi počítačovými zariadeniami. % \cite{}
Vzhľadom na to, že funkčnosť technológie NEL sa zakladá na komunikácií za pomoci protokolu HTTPS, % \cite{}
...
% TODO how to cite my own figure
\begin{figure}[htb]
\begin{center}
...
% TODO cite image from mozila mdn probably
\begin{figure}[htb]
\begin{center}
...
% TODO cite probably RFC is enough
...
% TODO cite also probably only the RFC for http
...
\begin{enumerate}
    % TODO see rules for itemizations and enumerations
...
% TODO cite https://httpwg.org/specs/rfc7230.html, https://httpwg.org/specs/rfc7231.html
...
Webová stránka (skrátene \textbf{webstránka}) je typ dokumentu, ktorého obsahom je hypertext alebo hypermédiá štruktúrované vo formáte \textbf{HTML}.
...
% TODO how to cite my own listing
\begin{center}
\centering
...
% TODO web servers collecting NEL reports -> COLLECTORS (define this term)
...
% TODO použiť prehľad z Cloudflare NEL reportu o využívaní (NEXI NB)
