...
Obsahom hlavičky \code{Report-To} musí byť textová hodnota vo formáte JSON (viď sekciu \ref{json}), pričom jej štruktáru tvorí striktne JSON array objektov.
...
Ak v pamäti webového prehliadača exisuje aspoň jedno pravidlo \code{NEL} využívajúce exitujúce pravidlo \code{Report-To}, 
