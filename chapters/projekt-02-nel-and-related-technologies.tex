...
\begin{center}
 ...
 \caption{Vizualizácia webového prostredia \cite{mdn-docs-http-overview}.}
...
\begin{center}
 ...
 \caption{Základná štruktúra hodnoty URL. Obrázok je prevzatý z internetu.}
...
\begin{center}
 ...
 \caption{Príklad rozdelenia na efektívnu TLD a registrovateľnú doménu.}
...
\begin{center}
    ...
    \caption{Klient-server komunikácia.}
...
\begin{center}
    ...
    \caption{Príklad HTTP žiadosti \cite{mdn-docs-http-overview}.}
...
\begin{center}
    ...
    \caption{Príklad HTTP odpovede \cite{mdn-docs-http-overview}.}
...
\begin{center}
\centering
\begin{lstlisting}[caption={Základná štruktúra HTML dokumentu.},
...
\centering
\begin{lstlisting}[
caption={Príklad dokumentu JSON.},
...
\centering
\begin{lstlisting}[
caption={Príklad obsahu zaslaného hlásenia pre zlyhanie webového prehliadača.},
...
Príklad použitia NEL spolu s Reporting API.},
