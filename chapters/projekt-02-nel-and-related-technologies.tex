...
25. septembra 2018, taktiež označovanou ako verzia \textbf{v0}.
Ďalej teda opisujem výhradne Reporting API verzie v0.
...
% Asi si tu zamienam pojmy prehliadac a user agent
...
\begin{itemize}
    ...
    \item Konfigurácia
    \item Príklady
    \item NEL-Client-side-Measurements... článok, skecie 2, 3
\end{itemize}
