...
Na základe týchto troch potrebných krokov pre úspešné získanie zdroja ďalej popisujem rôzne zlyhania v troch samotatných kategóriach:
\begin{enumerate}
...
\subsection{Zlyhania komunikácie s DNS}

\subsection{Zlyhania nadviazania spojenia TCP/IP}

\subsection{Zlyhania prenosu HTTP}



\subsection{Nástroje pre monitorovanie zlyhaní}
