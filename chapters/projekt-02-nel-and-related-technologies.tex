...
Príkladom typickej URL môže byť \code{https://priklad.com/dokument}, kde \code{https://} označuje komunikačný protokol, \code{priklad.com} doménu web servera a \code{dokument} cestu k dokumentu. 
