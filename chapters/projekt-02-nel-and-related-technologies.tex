...
README:
\begin{itemize}
    \item Túto sekciu som zatiaľ spísal ako test --- toto nie je reálny stav kapitoly \ref{nel-and-related-technologies}, ale iba placeholder
    \item Kapitola 2 bude zhruba obsahovať
    \begin{enumerate}
        \item Úvod do HTTP
        \item Úvod do Web Reliability a monitorovania chýb
        \item Špecifikáciu NEL
        \item Špecifikáciu Report API (čo najviac skrátene)
    \end{enumerate}
    \item Doposiaľ jediná, relatívne schopne napísaná kapitola vhodná na REVIEW je kapitola \ref{data-sources-available-for-research}
\end{itemize}
\todo{Sekcie môžu byť zatiaľ nekoherentné a bude nutné ich prekontrolovať a napraviť}
\\
Web reliability
\\
