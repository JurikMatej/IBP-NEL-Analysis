...
V rámci celkového výstupného zoznamu Majestic Million sa berú do úvahy domény, \textbf{ale aj ich sub-domény}, takže sa môže stať, že napríklad doména \code{google.com} 
...
\todo{Je potrebné zvážiť čo napíšem sem a čo vysvetlím inde, pretože sa používa na viacerých miestach}
...
Dáta o návštevnosti domén sú získavané zo sieťovej premávky na Cloudflare \code{1.1.1.1} DNS rezolveri. 
...
\todo{Describe useful and necessary parts of selenium}
...
Na GCP je dostupné množstvo datasetov na prehľadávanie.
