...
Na oficiálnej stránke crawler.ninja autor tieto súbory spätne zverejňuje pod licenciou \todo{licencia}, takže sú veškeré získané dáta použiteľné pre študijné, ale aj komerčné účely potencionálnych záujemcov.

Okrem zberu dát ich Scott používa na už spomínaný prieskum o bezpečnosti na internete a na svojej stránke tiež zverejňuje odkazy na blog, kde uverejňuje výsledky priebežných zistení.
Mimo dát sú od neho dostpné taktiež ...
