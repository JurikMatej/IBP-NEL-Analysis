...
\todo{Je potrebné zvážiť čo napíšem sem a čo vysvetlím inde, pretože sa používa na viacerých miestach --- ZATIAĽ SOM NESTIHOL}
...
Dáta o návštevnosti domén sú získavané zo sieťovej premávky na Cloudflare \code{1.1.1.1} DNS resolveri.
...
\todo{Describe necessary and useful parts of selenium}
