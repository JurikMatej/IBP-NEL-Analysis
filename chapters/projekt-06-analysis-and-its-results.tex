...
Zistil som, že tieto domény používajú jednu konfiguráciu pre majoritu svojich zdrojov a druhú pre menšiu množinu \textit{vybraných} zdrojov.
...
Napríklad, na doméne \code{comparepower.com} som našiel väčšinovú konfiguráciu pre všetky monitorované webstránky a obrázky so 100\% hlásením zlyhaní a 1\% hlásením úspechov. 
...
V prípadoch, že obe konfigurácie využívali \code{cloudflare.com} kolektor, jedna bola nastavená pre hlavné zdroje domény a druhá pre tie vedľajšie, najčastejšie skripty prevziate od samotného cloudflare.
