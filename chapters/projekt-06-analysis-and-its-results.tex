...
Mnou implementovaná knižnica \code{nel\_analysis.py} okrem \textit{pandas} používa aj ďalšiu prevziatu knižnicu -- \textit{publicsuffix2}\footnote{\href{https://pypi.org/project/publicsuffix2/}{https://pypi.org/project/publicsuffix2/}}.
...
Rozhodol som sa ich implementovať tak, aby som ich vstupy mohol ľubovolne prispôsobiť a výstupy použiť priamo v sekcií s výsledkami tejto práce.
...
Názvy skriptov pre dáta získané automatizovaným prehliadavaním webu začínajú prefixom \code{crawled\_*}.
